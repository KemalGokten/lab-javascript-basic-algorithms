...
//
console.log("Bonus 2 Challange 1 Solution->1");
let phraseToCheck = "A man, a plan, a canal, Panama!"

const trimmedPhrase = phraseToCheck.replace(/[^A-Za-z0-9]/g, '').toLowerCase();
let isPalindrome = true;

for(let i = 0; i < cleanStr.length; i++){
    if(trimmedPhrase[i] !== trimmedPhrase[trimmedPhrase.length - 1 - i]){
        isPalindrome = false;
    }
}
...
//
console.log("Bonus 2 Challange 1 Solution->2");

isPalindrome = trimmedPhrase.split('').every((char, index) => char === trimmedPhrase[trimmedPhrase.length - 1 - index]);
isPalindrome ? console.log(`${phraseToCheck} is a palindrome`) : console.log(`${phraseToCheck} is not a palindrome`);

//
console.log("Bonus 2 Challange 1 Solution->3");

trimmedPhrase === trimmedPhrase.split('').reverse().join('') ? 
console.log(`${phraseToCheck} is a palindrome`) : console.log(`${phraseToCheck} is not a palindrome`);
